...
import 'package:the_exchange_online/data/request/api_url.dart';
import 'package:the_exchange_online/data/request/request.dart';

class LocationRepository {
  final Request _request = Request(baseUrl: LocationApi.BASE_URL);
